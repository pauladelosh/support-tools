# Generated by: aht meta:tab-completion -g --shell-type=bash -p "aht"
function _aht_20160412_complete {
    ...
    RESULT="$(aht meta:tab-completion </dev/null)";
    STATUS=$?;
...
if [ "$(type -t _get_comp_words_by_ref)" == "function" ]; then
    complete -F _aht_20160412_complete "aht";
else
    >&2 echo "Completion was not registered for aht.";
