...
function ahtserver {
#  foot=`aht --$4 @$1.$2 ssh sudo -u root du -sh /var/www/repo/$1 "\|" awk '{print $1}' 2>/dev/null </dev/null`
  foot=`aht --$4 @$1.$2 ssh sudo -u root du -sk /var/www/html/$1 "\|" awk '{print $1}' 2>/dev/null </dev/null`
